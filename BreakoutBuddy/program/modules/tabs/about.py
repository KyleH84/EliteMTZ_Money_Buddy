...
**When to use:** Curate and export a focused list for the day, or sanity‑check what made it into Dashboard.
""")
...
**Notes:** The app is fully functional **without** agents. Quick Explain always falls back to a strong rule‑based analysis.
""")
...
""")
    ...
    with st.expander("Data model & files", expanded=False):
        st.markdown("""
- Default data directory: `Data/` under the app root (override via **Admin ▸ Data folder** or `BREAKOUTBUDDY_DATA` env var).
